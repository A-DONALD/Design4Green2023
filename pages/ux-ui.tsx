...
const UXUI: NextPage<{ goodPractices: GoodPracticesType[], recommendations: string[] }> = ({ goodPractices, recommendations }) => {
...
export async function getStaticProps() {
    ...
    const goodPractices = GoodPracticesModel.getCriteresWithFilter(Filter.thematique, 'UX/UI'),
        recommendations = GoodPracticesModel.getDatasCritereWithFilter(Filter.thematique, 'UX/UI')
